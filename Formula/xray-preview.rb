...
class XrayPreview < Formula
    desc "Xray, Penetrates Everything. Also the best v2ray-core, with XTLS support. Fully compatible configuration"
    homepage "https://xtls.github.io/"
    if Hardware::CPU.intel?
      url "https://github.com/XTLS/Xray-core/releases/download/v1.8.0/Xray-macos-64.zip"
      sha256 "533dec8374985618e7e86673f677bc8b68d462c3a870edf4635b8c42d3db7819" # Intel
    else
      url "https://github.com/XTLS/Xray-core/releases/download/v1.8.0/Xray-macos-arm64-v8a.zip"
